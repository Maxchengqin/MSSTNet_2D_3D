...
from ..gen_3d_sk_dict.preprocess import pre_normalization
...
def gendata(file_list, out_path, ignored_sample_path, benchmark, part):
    ...
    np.save('{}/{}_joint.npy'.format(out_path, part), fp)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='NTU-RGB-D 120 Skeleton Data Extraction')
    parser.add_argument('--part1-path', default='/data/cq/ntu_sk/NTU1-60/nturgb+d_skeletons/')
    parser.add_argument('--part2-path', default='/data/cq/ntu_sk/NTU61-120/')
    parser.add_argument('--ignored-sample-path',
                        default='NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out-folder', default='/data/cq/ntu_3dsk_pro/ntu120/')
